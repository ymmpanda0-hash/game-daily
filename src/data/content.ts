...
export const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-23',
    title: '“轻暗黑”刷宝ARPG《余烬之镇 Emberville》将于10月27日抢先体验',
    summary: '像素动作冒险RPG《余烬之镇》宣布10月27日Steam抢先体验，支持中文，愿望单已破60万。',
    url: 'https://www.gcores.com/articles/220127',
  },
  {
    id: 'news-28',
    tag: '新作',
    source: '机核',
    date: '2026-09-23',
    title: '《美德与重锤》将于10月28日发售',
    summary: 'Devolver Digital发行的叙事探索游戏《美德与重锤》将于10月28日发售，玩家将挥舞重锤穿越幽灵机器人遍布的故乡。',
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-23',
    title: '暴雪确认《星际争霸》开放世界射击游戏“非Xbox独占”',
    summary: '暴雪表示2030年发售的《星际争霸》开放世界射击游戏不会是Xbox独占，但未明确其他平台。',
  ...
  },
  {
    ...
    date: '2026-09-23',
    title: '《守墓人2》现已正式上线',
    summary: '《守墓人2》登陆PC与主机平台，Steam愿望单突破100万，售价85元。',
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-22',
    title: '高速动作Roguelite《Ved：疗愈所》9月22日正式发售',
    summary: '二次元3D动作Roguelite《Ved：疗愈所》登陆Steam，售价68元，上线前两周85折。',
    url: 'https://www.gcores.com/articles/220042',
  },
  {
    id: 'news-32',
    tag: '评分',
    source: '机核',
    date: '2026-09-22',
    title: '均分81：《寂静岭：Townfall》媒体评分汇总',
    summary: '《寂静岭：Townfall》媒体均分81，IGN与GameSpot均给出8分，游戏将于9月24日发售。',
...
export const promoItems: PromoItem[] = [
  ...
  },
  {
    ...
    date: '2026-09-23',
    title: '《美德与重锤》将于10月28日发售',
    summary: 'Devolver Digital发行的叙事探索游戏《美德与重锤》将于10月28日发售，挥舞重锤穿越幽灵机器人故乡。',
    url: 'https://www.gcores.com/articles/220090',
  },
  {
    id: 'promo-18',
  ...
  },
  {
    ...
    date: '2026-09-22',
    title: '高速动作Roguelite《Ved：疗愈所》9月22日正式发售',
    summary: '《Ved：疗愈所》正式版登陆Steam，售价68元，上线前两周享85折优惠。',
    url: 'https://www.gcores.com/articles/220042',
  },
  {
    id: 'promo-20',
    icon: 'Crown',
    date: '2026-09-22',
    title: '《检疫区：最后一站》免费DLC将于10月16日实装',
    summary: '《检疫区：最后一站》新DLC“迈阿密零”10月16日免费上线，带来新系统与玩法。',
  ...
  },
  {
    ...
    icon: 'Store',
    date: '2026-09-22',
    title: '《我们曾到此：明日遗踪》定于10月20日发售',
    summary: '合作解谜游戏《我们曾到此：明日遗踪》宣布10月20日发售，续写双人冒险故事。',
...
export const industryItems: IndustryItem[] = [
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-23',
    title: '贝塞斯达接管黑曜石，动视负责《光环》新作开发',
    summary: '微软Xbox宣布裁员268人并重组工作室：动视负责下一代《光环》，贝塞斯达接管黑曜石，Playground与Turn 10合并。',
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-22',
    title: '36期免息：英国运营商推出《GTA6》消费贷',
    summary: '英国维珍媒体O2推出《GTA6》36期免息分期购方案，首付20英镑，总价与官方售价持平。',
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-23',
    title: '米哈游两名前员工受贿被捕，一人涉案金额触及刑法最高量刑门槛',
    summary: '米哈游通报两起员工受贿案，两名前员工被逮捕，多名供应商负责人亦因涉嫌行贿被调查。',
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-23',
    title: '没有放弃《命运》！Bungie发布致歉声明',
    summary: 'Bungie负责人发布长文致歉，表示不会放弃《命运》，将恢复《命运2》已存入保险库的战役与突袭。',
  ...
  },
  {
    ...
    source: '机核',
    date: '2026-09-22',
    title: '小岛秀夫透露与索尼分手内幕，不清楚《Physint》是否登陆PS',
    summary: '小岛秀夫接受IGN采访透露索尼6月停止《Physint》注资，为保200名员工转向微软，未来是否登陆PS由微软决定。',
    url: 'https://www.gcores.com/articles/219982',
  },
];
